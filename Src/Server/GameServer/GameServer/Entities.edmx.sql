...
-- --------------------------------------------------
-- Date Created: 02/02/2025 17:38:22
-- Generated from EDMX file: J:\00_Projects\02_MMO\MyMMO\Src\Server\GameServer\GameServer\Entities.edmx
-- --------------------------------------------------
...
GO
IF OBJECT_ID(N'[dbo].[FK_TCharacterCharacterFriend]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[CharacterFriends] DROP CONSTRAINT [FK_TCharacterCharacterFriend];
GO
...
ALTER TABLE [dbo].[CharacterFriends]
ADD CONSTRAINT [FK_TCharacterCharacterFriend]
    FOREIGN KEY ([TCharacterID])
    REFERENCES [dbo].[Characters]
        ([ID])
    ON DELETE NO ACTION ON UPDATE NO ACTION;
...
-- Creating non-clustered index for FOREIGN KEY 'FK_TCharacterCharacterFriend'
CREATE INDEX [IX_FK_TCharacterCharacterFriend]
